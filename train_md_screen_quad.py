...
from dataset_md_screen_quad import custom_dataset_md_screen_quad
...
def train(train_img_path, train_gt_path, pths_path, batch_size, lr, num_workers, epoch_iter, interval, pretrained=None):
	...
	trainset = custom_dataset_md_screen_quad(train_img_path, train_gt_path)
...
def get_args():
	...
	parser.add_argument('--pths_path', default='./pths_zx_md_screen')
